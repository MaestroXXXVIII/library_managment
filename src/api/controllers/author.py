...
from src.features.author.exceptions import (
    AuthorNotFoundError,
    CreateAuthorError,
    DeleteAuthorError,
    UpdateAuthorError,
...
async def create_author(
    body: CreateAuthorDTO, interactor: FromDishka[CreateAuthorInteractor]
) -> None:
...
async def get_author_by_id(
    author_id: int, interactor: FromDishka[GetAuthorByIdInteractor]
) -> ResponseAuthorDTO:
    try:
...
async def update_author(
    body: UpdateAuthorDTO, author_id: int, interactor: FromDishka[UpdateAuthorInteractor]
) -> None:
